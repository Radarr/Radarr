...
module.exports = {
  ...
  warningColor: '#ffa500',
  infoColor: '#5d9cec',
  queueDownloadingColor: '#7a43b6',
  queuePausedColor: '#7a43b6',
  queueQueuedColor: '#7a43b6',
  queueErrorColor: '#7a43b6',
  queuePendingColor: '#7a43b6',
  queueImportingColor: '#7a43b6',
  queueWaitingColor: '#7a43b6',
  purple: '#7a43b6',
  pink: '#ff69b4',
  radarrYellow,
