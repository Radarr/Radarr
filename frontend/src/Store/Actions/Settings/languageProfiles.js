...
export default {
  ...
  actionHandlers: {
    [FETCH_LANGUAGE_PROFILES]: createFetchHandler(section, '/language'),
    [FETCH_LANGUAGE_PROFILE_SCHEMA]: createFetchSchemaHandler(section, '/language'),
    [SAVE_LANGUAGE_PROFILE]: createSaveProviderHandler(section, '/language'),
    [DELETE_LANGUAGE_PROFILE]: createRemoveItemHandler(section, '/language')
  },
