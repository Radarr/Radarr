...
namespace NzbDrone.Core.Test.Extras.Others
{
    ...
    public class OtherExtraFileServiceFixture : CoreTest<OtherExtraFileService>
    {
        ...
        public void Setup()
        {
            ...
            var extra = Builder<OtherExtraFile>.CreateNew()
            ...
            Mocker.GetMock<IExtraFileRepository<OtherExtraFile>>()
                ...
                .Returns(new List<OtherExtraFile>() { extra });
            ...
            [Values(false, true)] bool keep)
        {
            Mocker.GetMock<IConfigService>()
                .Setup(s => s.UpgradeKeepOtherFiles)
                .Returns(keep);
                ...
                case DeleteMediaFileReason.NoLinkedEpisodes:
                    {
                        Mocker.GetMock<IRecycleBinProvider>().Verify(
                            ...
                            Times.Never);
                        Mocker.GetMock<IExtraFileRepository<OtherExtraFile>>().Verify(
