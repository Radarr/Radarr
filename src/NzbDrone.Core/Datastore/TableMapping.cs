    ...
    public static class TableMapping
    {
        ...
        public static void Map()
        {
            ...
            Mapper.Entity<Movie>("Movies").RegisterModel()
                  ...
                  .LazyLoad(a => a.QualityProfiles, (db, a) => db.Query<QualityProfile>(new SqlBuilder(db.DatabaseType).Where<QualityProfile>(b => a.QualityProfileIds.Contains(b.Id))).ToList(), a => a.QualityProfileIds.Count > 0)
