            ...
            foreach (var report in reports)
            {
                ...
                try
                {
                    ...
                    if (parsedMovieInfo != null && !parsedMovieInfo.PrimaryMovieTitle.IsNullOrWhiteSpace())
                    {
                        ...
                        {
                            decision = new DownloadDecision(remoteMovie, new DownloadRejection(DownloadRejectionReason.UnknownMovie, pushedRelease ? "Unknown Movie. Unable to match to existing movie in Library using release name." : "Unknown Movie. Unable to match to correct movie using release name."));
                        }
                        else
                        {
