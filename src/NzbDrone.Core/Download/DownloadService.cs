...
namespace NzbDrone.Core.Download
{
    ...
    public class DownloadService : IDownloadService
    {
        ...
        private async Task DownloadReport(RemoteMovie remoteMovie, IDownloadClient downloadClient)
        {
            ...
            _logger.ProgressInfo("Report for {0} ({1}) sent to {2} from indexer {3}. {4}", remoteMovie.Movie.Title, remoteMovie.Movie.Year, downloadClient.Definition.Name, remoteMovie.Release.Indexer.SanitizeForLog(), downloadTitle.SanitizeForLog());
