...
namespace NzbDrone.Core.Download.Clients.QBittorrent
{
    ...
    public class QBittorrentSettings : DownloadClientSettingsBase<QBittorrentSettings>
    {
        ...
        [FieldDefinition(14, Label = "DownloadClientQbittorrentSettingsPreImport", Type = FieldType.Checkbox, HelpText = "DownloadClientQbittorrentSettingsPreImportHelpText")]
        public bool PreImportToDestination { get; set; }
