        ...
        public override HealthCheck Check()
        {
            ...
            if (automaticSearchEnabled.Empty())
            {
                return new HealthCheck(GetType(),
                    ...
                    _localizationService.GetLocalizedString("IndexerSearchCheckNoAutomaticMessage"),
            ...
            if (interactiveSearchEnabled.Empty())
            {
                return new HealthCheck(GetType(),
                    ...
                    _localizationService.GetLocalizedString("IndexerSearchCheckNoInteractiveMessage"),
            ...
            if (active.Empty())
            {
                return new HealthCheck(GetType(),
                    ...
                    _localizationService.GetLocalizedString("IndexerSearchCheckNoAvailableIndexersMessage"),
