...
namespace NzbDrone.Core.Extras
{
        ...
        where TExtraFile : ExtraFile, new()
    {
        ...
        {
            var seriesFiles = _extraFileService.GetFilesByMovie(movie.Id);

            Clean(movie, filesOnDisk, importedFiles, seriesFiles);

            return Filter(movie, filesOnDisk, importedFiles, seriesFiles);
        }
