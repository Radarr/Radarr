...
namespace NzbDrone.Core.Music
{
    ...
    {
        string BuildPath(Author artist, bool useExistingRelativeFolder);
    }
    ...
    public class ArtistPathBuilder : IBuildArtistPaths
    {
        ...
        public string BuildPath(Author artist, bool useExistingRelativeFolder)
        {
        ...
        private string GetExistingRelativePath(Author artist)
        {
