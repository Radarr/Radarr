...
namespace NzbDrone.Core.Organizer
{
    ...
    public class FileNameBuilder : IBuildFileNames
    {
        ...
        public static readonly Regex MovieTitleRegex = new Regex(@"(?<token>\{((?:(Movie|Original))(?<separator>[- ._])(Clean)?(Original)?(Title|Filename)(?<separator>[- ._])?(The)?)(?::(?<customFormat>[a-z0-9|]+))?\})",
