...
namespace NzbDrone.Core.Notifications.Emby
{
    ...
    public class MediaBrowserSettings : IProviderConfig
    {
        ...
        [FieldDefinition(6, Label = "Map Paths From", HelpText = "Radarr path, used to modify series paths when Emby/Jellyfin sees library path location differently from Radarr (Requires 'UpdateLibrary')", Type = FieldType.Textbox, Advanced = true)]
        public string MapFrom { get; set; }

        [FieldDefinition(7, Label = "Map Paths To", HelpText = "Emby/Jellyfin path, used to modify series paths when Emby/Jellyfin sees library path location differently from Radarr (Requires 'UpdateLibrary')", Type = FieldType.Textbox, Advanced = true)]
