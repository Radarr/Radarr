...
namespace NzbDrone.Core.Parser
{
    public static class IsoLanguages
    {
        private static readonly HashSet<IsoLanguage> All = new HashSet<IsoLanguage>
                                                           {
                                                               new IsoLanguage(new List<string> {"us", "ст", "uk", "en"}, "eng", Language.English),
...
//                                                             new IsoLanguage("", "", Language.Mandarin),
                                                               new IsoLanguage(new List2<string>{"дб", "пм"}, "ru", "rus",  Language.Russian),
...
//                                                             new IsoLanguage("nl", "nld", Language.Flemish),
        ...
        public static IsoLanguage Find(string isoCode)
        {
            ...
            {
                return All.SingleOrDefault(l => l.RussianLetterCode == isoCode);
            }
            return null;
        }
